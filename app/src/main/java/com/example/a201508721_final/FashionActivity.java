...
public class FashionActivity extends TabActivity {
    Button btexitFa;
    TextView tvTelfa, tvFahome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTelfa = (TextView) findViewById(R.id.tvTelfa);
        tvFahome = (TextView) findViewById(R.id.tvFahome);
        btexitFa = (Button) findViewById(R.id.btexitFa);

        tvTelfa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent;
                myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:024907502"));
                startActivity(myIntent);
            }
        });

        tvFahome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent;
                myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://hm.seoil.ac.kr/fashion"));
                startActivity(myIntent);
            }
        });

        btexitFa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
