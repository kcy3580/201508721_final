...
public class JapActivity extends TabActivity {
    Button btexitJap;
    TextView tvTeljap, tvJaphome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTeljap = (TextView) findViewById(R.id.tvTeljap);
        tvJaphome = (TextView) findViewById(R.id.tvJaphome);
        btexitJap = (Button) findViewById(R.id.btexitJap);

        tvTeljap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent;
                myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:024907488"));
                startActivity(myIntent);
            }
        });

        tvJaphome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent;
                myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://hm.seoil.ac.kr/jp"));
                startActivity(myIntent);
            }
        });

        btexitJap.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
