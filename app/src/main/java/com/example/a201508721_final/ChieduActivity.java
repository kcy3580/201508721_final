...
public class ChieduActivity extends TabActivity {
    Button btexitChiedu;
    TextView tvTelchiedu, tvChieduhome;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_chiedu);
        ...
        tvTelchiedu = (TextView) findViewById(R.id.tvTelchiedu);
        tvChieduhome = (TextView) findViewById(R.id.tvChieduhome);
        btexitChiedu = (Button) findViewById(R.id.btexitChiedu);

        tvTelchiedu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent;
                myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:024907470"));
                startActivity(myIntent);
            }
        });

        tvChieduhome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent;
                myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://hm.seoil.ac.kr/childhood"));
                startActivity(myIntent);
            }
        });

        btexitChiedu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
