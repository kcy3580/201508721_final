...
public class CarActivity extends TabActivity {
    Button btexitCar;
    TextView tvTelcar, tvCarhome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTelcar = (TextView) findViewById(R.id.tvTelcar);
        tvCarhome = (TextView) findViewById(R.id.tvCarhome);
        btexitCar = (Button) findViewById(R.id.btexitCar);

        tvTelcar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent;
                myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("tel:024907417"));
                startActivity(myIntent);
            }
        });

        tvCarhome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent myIntent;
                myIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://hm.seoil.ac.kr/sac"));
                startActivity(myIntent);
            }
        });

        btexitCar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                finish();
            }
